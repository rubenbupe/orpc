...
import type { AnySchema, ContractProcedureDef, ContractRouter, ErrorMap, MergedErrorMap, Meta, Route, Schema } from '@rubenbupe/orpc-contract'
...
import { mergeErrorMap, mergeMeta, mergePrefix, mergeRoute, mergeTags } from '@rubenbupe/orpc-contract'
