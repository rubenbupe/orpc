import type { ClientPromiseResult } from '@rubenbupe/orpc-client'
import type { AnyContractProcedure, AnySchema, ErrorFromErrorMap, ErrorMap, InferSchemaInput, InferSchemaOutput, Meta } from '@rubenbupe/orpc-contract'
